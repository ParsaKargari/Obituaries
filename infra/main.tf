...
locals {
  function_create_obituary = "create_obituary_30143368"
  function_get_obituaries  = "get_obituaries_30143368"
...
resource "aws_lambda_function" "create_obituary_30143368" {
...
# see the docs: https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_function
resource "aws_lambda_function" "get_obituaries_30143368" {
  ...
  "Statement": [
    {
      ...
      "Resource": ["arn:aws:logs:*:*:*", "${aws_dynamodb_table.obituary-30140335.arn}"],
      "Effect": "Allow"
    }
  ]
}
...
resource "aws_lambda_function_url" "url-create" {
  function_name      = aws_lambda_function.create_obituary_30143368.function_name
...
resource "aws_lambda_function_url" "url-get" {
  function_name      = aws_lambda_function.get_obituaries_30143368.function_name
  authorization_type = "NONE"
...
resource "aws_dynamodb_table" "obituary-30140335" {
  name         = "obituary-30140335"
